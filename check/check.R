...
files=vector('list',NLF)
for (i in 1:NLF) {
  files[[i]]=paste(select.drs[i],'/',dir(select.drs[i]),sep="")
  most.recent=which.max(sapply(files[[i]],function(x){file.info(x)$mtime}))
  #most recent written file in each selected directory
  loadfile[i]<-files[[i]][most.recent]
}
...
for (k in 1:NLF) {  
  ...
  #created=as.POSIXct(min(
  #          sapply(files[[k]],function(x){file.info(x)$ctime})
  #        ),origin = "1970-01-01")
  created=as.POSIXct(file.info(select.drs[k])$ctime,origin = "1970-01-01")
...
if (is.na(pdf.file) & new.windows) windows(10,10)
...
if (exists("DOSYNTH",where=note[[1]]) && note[[1]]$DOSYNTH) abline(h=Sstate[[1]]$oll.tot,col=cl[1]) #synth
if (NLF>1) for (k in 2:NLF) {
  ...
  if (exists("DOSYNTH",where=note[[k]]) && note[[k]]$DOSYNTH) abline(h=Sstate[[k]]$oll.tot,col=cl[k]) #synth
}
...
if (exists("DOSYNTH",where=note[[1]]) && note[[1]]$DOSYNTH) abline(h=(Sstate[[1]]$oup)$lpU.tot,col=cl[1]) #synth
if (NLF>1) for (k in 2:NLF) {
  ...
  if (exists("DOSYNTH",where=note[[k]]) && note[[k]]$DOSYNTH) abline(h=(Sstate[[k]]$oup)$lpU.tot,col=cl[k]) #synth
}
...
if (exists("DOSYNTH",where=note[[1]]) && note[[1]]$DOSYNTH) abline(h=Sstate[[1]]$obp,col=cl[1]) #synth
if (NLF>1) for (k in 2:NLF) {
  ...
  if (exists("DOSYNTH",where=note[[k]]) && note[[k]]$DOSYNTH) abline(h=Sstate[[k]]$obp,col=cl[k]) #synth
}

plot(density(P[[1]][burn[k]:N.sample.done[[1]],"oll"]),col=cl[1],ann=FALSE);
if (exists("DOSYNTH",where=note[[1]]) && note[[1]]$DOSYNTH) abline(v=Sstate[[1]]$oll.tot,col=cl[1]) #synth
if (NLF>1) for (k in 2:NLF) { 
  lines(density(P[[k]][burn[k]:N.sample.done[[k]],"oll"]),col=cl[k],lty=lt[k],ann=FALSE) 
  if (exists("DOSYNTH",where=note[[k]]) && note[[k]]$DOSYNTH) abline(v=Sstate[[k]]$oll.tot,col=cl[k]) #synth
  }
plot(density(P[[1]][burn[k]:N.sample.done[[1]],"lpU"]),col=cl[1],ann=FALSE);
if (exists("DOSYNTH",where=note[[1]]) && note[[1]]$DOSYNTH) abline(v=(Sstate[[1]]$oup)$lpU.tot,col=cl[1]) #synth
if (NLF>1) for (k in 2:NLF) { 
  lines(density(P[[k]][burn[k]:N.sample.done[[k]],"lpU"]),col=cl[k],lty=lt[k],ann=FALSE) 
  if (exists("DOSYNTH",where=note[[k]]) && note[[k]]$DOSYNTH) abline(v=(Sstate[[k]]$oup)$lpU.tot,col=cl[k]) #synth
  }
plot(density(P[[1]][burn[k]:N.sample.done[[1]],"obp"]),col=cl[1],lty=lt[1],ann=FALSE);
if (exists("DOSYNTH",where=note[[1]]) && note[[1]]$DOSYNTH) abline(v=Sstate[[1]]$obp,col=cl[1]) #synth
if (NLF>1) for (k in 2:NLF) { 
  lines(density(P[[k]][burn[k]:N.sample.done[[k]],"obp"]),col=cl[k],lty=lt[k],ann=FALSE)
  if (exists("DOSYNTH",where=note[[k]]) && note[[k]]$DOSYNTH) abline(v=Sstate[[k]]$obp,col=cl[k]) #synth
  }

if (is.na(pdf.file) & new.windows) windows(); 
par(mfcol=c(3,2))
plot(burn[1]:N.sample.done[[1]],P[[1]][burn[1]:N.sample.done[[1]],"rho"],col=cl[1],lty=lt[1],type='l',xlim=c(aa,bb),ylim=c(0,1)); points(N.sample.done[[1]],P[[1]][N.sample.done[[1]],"rho"],pch=16,col=1)
if (exists("DOSYNTH",where=note[[1]]) && note[[1]]$DOSYNTH) abline(h=Sstate[[1]]$rho,col=cl[1]) #synth
if (NLF>1) for (k in 2:NLF) {
  ...
  if (exists("DOSYNTH",where=note[[k]]) && note[[k]]$DOSYNTH) abline(h=Sstate[[k]]$rho,col=cl[k]) #synth
}
...
if (exists("DOSYNTH",where=note[[1]]) && note[[1]]$DOSYNTH) abline(h=Sstate[[1]]$theta,col=cl[1]) #synth
if (NLF>1) for (k in 2:NLF) {
  ...
  if (exists("DOSYNTH",where=note[[k]]) && note[[k]]$DOSYNTH) abline(h=Sstate[[k]]$theta,col=cl[k]) #synth
}
if (exists("DOP",where=note[[1]])) {
  ...
  if (exists("DOSYNTH",where=note[[1]]) && note[[1]]$DOSYNTH) abline(h=Sstate[[1]]$p,col=cl[1]) #synth
  if (NLF>1) for (k in 2:NLF) {
    ...
    if (exists("DOSYNTH",where=note[[k]]) && note[[k]]$DOSYNTH) abline(h=Sstate[[k]]$p,col=cl[k]) #synth
  }
}

plot(density(P[[1]][burn[k]:N.sample.done[[1]],"rho"],from=0,to=1),col=cl[1],lty=lt[1],ann=FALSE);
if (exists("DOSYNTH",where=note[[1]]) && note[[1]]$DOSYNTH) abline(v=Sstate[[1]]$rho,col=cl[1]) #synth
if (NLF>1) for (k in 2:NLF) { 
  lines(density(P[[k]][burn[k]:N.sample.done[[k]],"rho"],from=0,to=1),
                         col=cl[k],lty=lt[k],ann=FALSE) 
  if (exists("DOSYNTH",where=note[[k]]) && note[[k]]$DOSYNTH) abline(v=Sstate[[k]]$rho,col=cl[k]) #synth
  }
plot(density(P[[1]][burn[k]:N.sample.done[[1]],"theta"],from=0.7,to=1),col=cl[1],lty=lt[1],ann=FALSE);
if (exists("DOSYNTH",where=note[[1]]) && note[[1]]$DOSYNTH) abline(v=Sstate[[1]]$theta,col=cl[1]) #synth
if (NLF>1) for (k in 2:NLF) { 
  lines(density(P[[k]][burn[k]:N.sample.done[[k]],"theta"],from=0,to=1),
                         col=cl[k],lty=lt[k],ann=FALSE) 
  if (exists("DOSYNTH",where=note[[k]]) && note[[k]]$DOSYNTH) abline(v=Sstate[[k]]$theta,col=cl[k]) #synth
  }
if (exists("DOP",where=note[[1]])) {
  plot(density(P[[1]][burn[k]:N.sample.done[[1]],"p"],from=0,to=0.4),col=cl[1],lty=lt[1],ann=FALSE); 
  if (exists("DOSYNTH",where=note[[1]]) && note[[1]]$DOSYNTH) abline(v=Sstate[[1]]$p,col=cl[1]) #synth
  if (NLF>1) for (k in 2:NLF) { 
    lines(density(P[[k]][burn[k]:N.sample.done[[k]],"p"],from=0,to=1),
                           col=cl[k],lty=lt[k],ann=FALSE) 
    if (exists("DOSYNTH",where=note[[k]]) && note[[k]]$DOSYNTH) abline(v=Sstate[[k]]$p,col=cl[k]) #synth
  }
